...
def insert_quadrado_diferenca(editor):
    ...
    front_text = (f"<b>Produtos Notaveis - Quadrado da Diferença</b><br><font color='blue'>Desenvolva a seguinte expressão: ({coef_a}a - {coef_b}b)^2</font>")
    ...
    back_text = (f"<b>Desenvolvimento:</b><br>"
                 f"quadrado do primeiro termo, menos duas vezes o primeiro termo vezes o segundo mais, o quadrado do segundo termo.<br><br>"
