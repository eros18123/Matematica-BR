...
def insert_numeric_interval_fechado(editor):
    ...
    front_text = (f"<b>Intervalos Númericos Fechados</b><br>"
                  f"Faça o intervalo fechado de extremos entre A e B<br>"
                  f"Sendo A={A} e B={B}")
    ...
    back_text = (f"<b>Desenvolvimento:</b><br>"
                 ...
                 f"    <td style='width:1cm; text-align:center;'><div style='width:100%; text-align:center; height: 10px; width: 10px; border-radius: 50%; background-color: black; margin: 0 auto; border: 5px solid yellow;'></div></td>"
